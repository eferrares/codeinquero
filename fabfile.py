...
env.hosts = ['startuplife']  # CHANGEME
...
env.domains = ['ec2-34-229-239-118.compute-1.amazonaws.com']  # CHANGEME
...
env.reqs_path = 'requirements/local.txt'
...
templates = {
    ...
    "settings": {
        "local_path": "codeinquero/settings/local-dist.py",
        "remote_path": "%(proj_path)s/%(proj_app)s/local.py",
    },
}
