...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            os.path.join(PROJECT_ROOT, 'codeinquero/templates'),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'codeinquero.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'codeinquero',
        'USER': 'codeinquero',
        'PASSWORD': 'UltraHardPassForProject',
        'HOST': 'localhost',
        'PORT': '',
    },
}
...
SYSTEM_EMAIL_PREFIX = "[codeinquero]"

## Log settings

LOG_LEVEL = logging.INFO
HAS_SYSLOG = True
SYSLOG_TAG = "http_app_codeinquero"  # Make this unique to your project.
