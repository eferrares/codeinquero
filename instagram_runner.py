...
class HashTagSearch(metaclass=ABCMeta):
    ...
    def extract_recent_tag(self, tag):
        ...
        if 'TagPage' in shared_data['entry_data']:
    ...
    def get_enterprise(self, hashtags):
        for hashtag in hashtags:
            enterprise = Enterprise.objects.filter(hashtag=hashtag.lower())
            if enterprise:
                return enterprise[0]
        return None
